...
## Project Ideas
Just an idea board until further notice, this list has the things I'd like to work on. An [Active Projects] section will be made as I make progress. 

* Photography -- Filter Toolbox
    * I have a few particular ideas for filters and manipulations that I'd like to make. Among them, the biggest is pixel sorting. I'd like to bundle this into a large toolbox that I could reuse as necessary. It will probably be built in Python. 
* Big Data -- Dota Data Scraper
    * Without currently having a plan for how to use it, I'd like to see how much data I can scrape out of my Dota 2 matches using their API. I don't know what kind of analytics I intend on providing, but I'd like to investigate trends in my play, and see if I can learn anything new about myself. 
* Integrated Systems -- Kinect Repurposing
    * This is a planless one, I have this Xbox Kinect that's been collecting dust, and many others have created really awesome tools with one. I'd like to do something with mine, potentially borrowing someone else's interface.

<br>

## Outreach 
Currently, my goal is to establish and work on projects myself. In the future, I may want to open up my repositories and work with others on things at a larger scale. I don't have specific timeframe for this, but comments on this site are welcomed at the contact info in the <a href="/About">About</a> section.
